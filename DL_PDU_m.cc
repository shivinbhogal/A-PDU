...
int DL_PDU::getSc() const
{
    return sc_var;
}

void DL_PDU::setSc(int sc)
{
    this->sc_var = sc;
}

int DL_PDU::getDst() const
{
    return dst_var;
}

void DL_PDU::setDst(int dst)
{
    this->dst_var = dst;
}
...
int DL_PDUDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "sc")==0) return base+1;
...
std::string DL_PDUDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getSc());
...
bool DL_PDUDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setSc(string2long(value)); return true;
